...
Experienced **MERN Stack Developer** with **1+ years** of expertise in building scalable web applications. Currently leading development of **ZapShift**, a workforce management platform at Programming Hero. Passionate about clean code architecture, performance optimization, and mentoring junior developers.
...
**Key Achievements:**
- Led a team of 4 developers to build the platform from scratch
- Implemented real-time shift swapping with WebSocket integration
- Reduced API response time by 40% through query optimization
- Developed an admin dashboard with advanced analytics

**Tech Stack:** React, Node.js, Express, MongoDB, Firebase, Redux Toolkit, Tailwind CSS
...
1. **[ZapShift](https://github.com/mrshanshuvo/zap-shift-client)** - Workforce management platform (Team Lead)
2. **[English Janala](https://github.com/mrshanshuvo/english-janala)** - Language learning platform (Solo Developer)
3. **[E-commerce API](https://github.com/mrshanshuvo/ecommerce-api)** - Scalable backend service (Open Source)
...
- MERN Stack consulting projects

**Preferred Work:**
- Remote opportunities
- Product-based companies
- Tech startups with challenging problems
